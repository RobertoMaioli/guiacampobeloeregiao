...
══════════════════════════════════════════════ */
/* Injeta CSS do header scrolled via JS — funciona em todas as páginas com Tailwind CDN */
(function() {
  ...
  style.textContent = `
    ...
    .header-scrolled #header-search-icon {
      border-color: rgba(61,71,51,.2) !important;
