...
<body>
  ...
  <main class="stage">
    ...
    <div class="card">
      ...
      <!-- Headline -->
      <h1 class="headline">
        Chegaremos em<br/><em>breve</em>, promessa.
      </h1>

      <!-- Body -->
      <p class="body-text">
        Estamos aprimorando a experiência para entregar um Guia completo de Campo Belo e Região.
      ...
      <div class="socials">
        ...
        <a href="https://www.instagram.com/campobelospdicas/" target="_blank" rel="noopener"
  ...
  <div class="footer-strip">
    ...
    <span>Desenvolvido por <a href="https://maiolidesign.com.br" target="_blank" rel="noopener">Maioli Design</a></span>
  </div>
